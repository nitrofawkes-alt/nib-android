...
public class NibBridgeCurtainService extends Service {
 ...
 private void showCurtain(){
  ...
  String html="<!doctype html><html><head><meta name='viewport' content='width=device-width,initial-scale=1,maximum-scale=1'><style>"+
   ...
   ".hint{position:absolute;left:28px;right:28px;bottom:11%;text-align:center;color:#655a73;font:10px/1.4 ui-monospace,monospace}"+
   ...
   "</style></head><body><div class='label'>Nib · thinking</div><div class='stage'><div class='nib'><div class='dots'><i></i><i></i><i></i></div><img src='https://nib-companion.floot.app/_cdn/static/nib-expression-skeptical.png' alt='Nib'></div></div><div class='copy'><h1 id='main'>One sec. I’m borrowing the big brain.</h1><p id='detail'>Doing the boring machinery underneath…</p></div><div class='hint'>ChatGPT is working behind this curtain. Nib will come back when the answer is ready.</div><script>"+
